...
import morningAdhkarData from '@/data/morning.json'
...
const morningAdhkar: AdhkarItem[] = morningAdhkarData.map(item => ({
  ...item,
  user: {
    id: 1,
    name: "System"
...
export default function MorningAdhkarIndex() {

  return (
    <AppLayout>
      <Head title="Morning Adhkar" />
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Daily morning remembrances and supplications to start your day with Allah's blessings.
          </p>
        </div>

        {/* Adhkar Carousel */}
        {morningAdhkar.length > 0 ? (
          ...
          <div className="text-center py-12">
            <Sun className="mx-auto h-12 w-12 text-muted-foreground mb-4" />
        ...
        {/* <div className="mt-12 flex justify-center gap-20 max-w-2xl mx-auto">
          <div className="text-center">
            <div className="text-3xl font-bold text-primary">{morningAdhkar.length}</div>
